...
if(isset($_SESSION["administrador"])){
    ...
    if(isset($_COOKIE["administrador"])){
        ...
        $mensaje='<div class="alert alert-info" role="alert">Ya cuenta con una sesi&oacute;n activa, ¿Deseas <a href="../dashboard/?notification=Bienvenido(a) '.$nombre.'&notification_type=check">continuar</a> o <a href="../dashboard/logout.php">cerrar sesi&oacute;n</a>?. S:2</div>';
    }
}
?>
<!DOCTYPE html>
